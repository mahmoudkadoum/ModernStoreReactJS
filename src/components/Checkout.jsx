                        ...
                        <form className="needs-validation" noValidate="">
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="firstName" defaultValue="" required="" placeholder="First name" />
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="lastName" defaultValue="" required="" placeholder="Last name" />
                                    <div className="invalid-feedback">
